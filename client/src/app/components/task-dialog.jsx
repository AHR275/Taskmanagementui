...
export function TaskDialog({ isOpen, onClose, onSubmit, initialTask, categories }) {
  ...
  const [recurringReminderInterval, setRecurringReminderInterval] = useState(undefined);
  ...
  const handleSubmit = (e) => {
    ...
    if (scheduleType !== 'one-time') {
      if (scheduleType === 'daily') {
        ...
        recurrence = { pattern: 'weekly' , daysOfWeek: selectedDaysOfWeek };
      } else if (scheduleType === 'monthly') {
        recurrence = { pattern: 'monthly' , daysOfMonth: selectedDaysOfMonth };
